...
// Función para generar audio sintético
const generateSyntheticAudio = (frequency: number, duration: number, type: 'sine' | 'square' | 'sawtooth' = 'sine') => {
...
export const SimplePromoV15: React.FC<SimplePromoV15Props> = ({
  headline,
  ...
  return (
    <AbsoluteFill style={{ 
      ...
      <Sequence from={scenes.hook.start} durationInFrames={scenes.hook.duration}>
        ...
        {/* Audio whoosh sintético */}
        <Audio src={generateSyntheticAudio(200, 0.5, 'sawtooth')} startFrom={0} volume={0.6} endAt={15} />
      </Sequence>
      ...
      <Sequence from={scenes.prompt.start} durationInFrames={scenes.prompt.duration}>
        ...
        {/* Audio teclado sintético */}
        <Audio src={generateSyntheticAudio(800, 2, 'square')} startFrom={60} volume={0.4} endAt={120} />
      </Sequence>
      ...
      <Sequence from={scenes.generation.start} durationInFrames={scenes.generation.duration}>
        ...
        {/* Audio swoosh sintético */}
        <Audio src={generateSyntheticAudio(300, 0.7, 'sawtooth')} startFrom={0} volume={0.5} endAt={20} />
      </Sequence>
      ...
      <Sequence from={scenes.playlist.start} durationInFrames={scenes.playlist.duration}>
        ...
        {/* Audio clicks sintéticos */}
        {exactTracks.slice(0, 3).map((_, index) => (
          <Audio
            key={index}
            src={generateSyntheticAudio(1000 + index * 100, 0.2, 'square')}
      ...
      <Sequence from={scenes.final.start} durationInFrames={scenes.final.duration}>
        ...
        {/* Audio success sintético */}
        <Audio src={generateSyntheticAudio(660, 1, 'sine')} startFrom={75} volume={0.6} endAt={105} />
      </Sequence>
      ...
      <Sequence from={scenes.cta.start} durationInFrames={scenes.cta.duration}>
        ...
        {/* Audio click final sintético */}
        <Audio src={generateSyntheticAudio(1200, 0.3, 'square')} startFrom={85} volume={0.8} endAt={95} />
      </Sequence>
