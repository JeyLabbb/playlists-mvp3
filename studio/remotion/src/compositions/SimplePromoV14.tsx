...
export const SimplePromoV14: React.FC<SimplePromoV14Props> = ({
  headline,
  ...
  return (
    <AbsoluteFill style={{ 
      ...
      <Sequence from={scenes.hook.start} durationInFrames={scenes.hook.duration}>
        ...
        {/* Audio whoosh */}
        <Audio src="/audio/whoosh.wav" startFrom={0} volume={0.6} endAt={15} />
      </Sequence>
      ...
      <Sequence from={scenes.prompt.start} durationInFrames={scenes.prompt.duration}>
        ...
        {/* Audio teclado */}
        <Audio src="/audio/keyboard clicks.wav" startFrom={60} volume={0.4} endAt={120} />
      </Sequence>
      ...
      <Sequence from={scenes.generation.start} durationInFrames={scenes.generation.duration}>
        ...
        {exactTracks.map((track, index) => {
          ...
          const audioFiles = [
            '/audio/Do You Remember-Xiyo Fernandezz Eix.m4a',
            '/audio/Pa Q Me Escribes-Vreno Yg.m4a',
            '/audio/Suena Cool-Mvrk Lhaine.m4a',
            '', // Sin audio para Guxo
        ...
        {/* Audio swoosh */}
        <Audio src="/audio/swoosh.mp3" startFrom={0} volume={0.5} endAt={20} />
      </Sequence>
      ...
      <Sequence from={scenes.final.start} durationInFrames={scenes.final.duration}>
        ...
        {/* Audio success */}
        <Audio src="/audio/success.wav" startFrom={75} volume={0.6} endAt={105} />
      </Sequence>
      ...
      <Sequence from={scenes.cta.start} durationInFrames={scenes.cta.duration}>
        ...
        {/* Audio click final */}
        <Audio src="/audio/button click.wav" startFrom={85} volume={0.8} endAt={95} />
      </Sequence>
