...
export const MUSICAL_CONTEXTS = {
  underground_es: {
    ...
    compass: [
      ...
      "Soto Asa", "Israel B", "Cecilio G", "Dellafuente", "Hoke", "Louis Amoeba",
      "Ill Pekeño", "Ergo Pro", "Dano", "Recycled J", "Love Yi",
      ...
      "Raul Clyde", "Juseph", "La Pantera", "Juicy Bae", "Gatti", "agorazein", "Greta", "Uve Key", "Swiper"
    ]
  },
